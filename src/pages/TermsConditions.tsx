...
import { FileText, Shield, CreditCard, Wrench, AlertTriangle, CheckCircle, Clock, DollarSign, Phone, Mail, Car, Truck, Settings } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          ...
          {/* NOUVELLES SECTIONS 8-12 */}

          {/* Section 8: Pièces mécaniques */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                8. {t('terms.parts.title')}
              </h2>
            </div>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                {t('terms.parts.payment')}
              </p>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                {t('terms.parts.search.fees')}
              </p>
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-700">
                <p className="text-blue-800 dark:text-blue-400">
                  {t('terms.parts.options')}
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                9. {t('terms.exclusions.title')}
              </h2>
            </div>
            <div className="prose dark:prose-invert max-w-none">
              <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg border border-red-200 dark:border-red-700 mb-4">
                <h3 className="font-semibold text-red-900 dark:text-red-300 mb-2">{t('terms.exclusions.safety.title')}</h3>
                <p className="text-red-800 dark:text-red-400">
                  {t('terms.exclusions.safety.content')}
                </p>
              </div>

              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">{t('terms.exclusions.vehicles.title')}</h3>
              <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 mb-4">
                <li>{t('terms.exclusions.vehicles.trucks')}</li>
                <li>{t('terms.exclusions.vehicles.german')}</li>
                <li>{t('terms.exclusions.vehicles.non.canadian')}</li>
                <li>{t('terms.exclusions.vehicles.luxury')}</li>
                <li>{t('terms.exclusions.vehicles.emergency')}</li>
              </ul>

              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">{t('terms.exclusions.location.title')}</h3>
              <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 mb-4">
                <li>{t('terms.exclusions.location.street')}</li>
                <li>{t('terms.exclusions.location.private')}</li>
                <li>{t('terms.exclusions.location.authorization')}</li>
              </ul>

              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">{t('terms.exclusions.weather.title')}</h3>
              <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 mb-4">
                <li>{t('terms.exclusions.weather.snow')}</li>
                <li>{t('terms.exclusions.weather.temperature')}</li>
              </ul>

              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">{t('terms.exclusions.insurance.title')}</h3>
              <p className="text-gray-700 dark:text-gray-300">
                {t('terms.exclusions.insurance.content')}
              </p>
            </div>
          </motion.div>

          {/* Section 10: Pourboires et relations clientèle */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">{t('terms.tips.access.title')}</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                {t('terms.tips.access.content')}
              </p>

              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">{t('terms.tips.preparation.title')}</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                {t('terms.tips.preparation.content')}
              </p>

              <p className="text-gray-700 dark:text-gray-300">
                {t('terms.tips.electrical')}
              </p>
            </div>
          </motion.div>

          {/* Section 11: Essais routiers */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                11. {t('terms.road.tests.title')}
              </h2>
            </div>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                {t('terms.road.tests.procedure')}
              </p>
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-700 mb-4">
                <p className="text-blue-800 dark:text-blue-400">
                  {t('terms.road.tests.license')}
                </p>
              </div>
              <p className="text-gray-700 dark:text-gray-300">
                {t('terms.road.tests.insurance')}
              </p>
            </div>
          </motion.div>

          {/* Section 12: Frais environnementaux */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                12. {t('terms.environmental.title')}
              </h2>
            </div>
            <div className="prose dark:prose-invert max-w-none">
              <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-700 mb-4">
                <p className="text-green-800 dark:text-green-400 mb-2">
                  {t('terms.environmental.fees.included')}
                </p>
              </div>

              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">{t('terms.environmental.disposal.title')}</h3>
              <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 mb-4">
                <li>{t('terms.environmental.disposal.parts')}</li>
                <li>{t('terms.environmental.disposal.keep')}</li>
                <li>{t('terms.environmental.disposal.no.used')}</li>
              </ul>

              <p className="text-gray-700 dark:text-gray-300">
                {t('terms.environmental.protection')}
              </p>
            </div>
          </motion.div>
