  ...
  const slides: Slide[] = [
    {
      ...
      descriptionFr: "Nos mécaniciens mobile se déplacent vers vous avec tout l'équipement nécessaire pour diagnostiquer et réparer votre véhicule sur place.",
      descriptionEn: "Our mobile mechanics come to you with all the necessary equipment to diagnose and repair your vehicle on-site.",
    ...
    },
    {
      ...
      descriptionFr: "Service complet de changement de pneus saisonniers. Installation, balancement et vérification de la pression inclus.",
      descriptionEn: "Complete seasonal tire change service. Installation, balancing and pressure check included.",
    ...
    },
    {
      ...
      descriptionFr: "Nous sommes disponibles 7 jours pour tous vos besoins mécaniques. Rendez-vous flexibles selon votre horaire.",
      descriptionEn: "We are available 7 days a week for all your mechanical needs. Flexible appointments according to your schedule.",
