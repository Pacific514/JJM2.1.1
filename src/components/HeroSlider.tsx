...
const HeroSlider: React.FC = () => {
  ...
  const slides: Slide[] = [
    ...
    },
    {
      ...
      descriptionFr: "Rendez-vous flexibles selon votre horaire. Mécaniciens disponibles 7 jours pour tous vos besoins pneus et mécaniques. ",
      descriptionEn: "Flexible appointments according to your schedule. Mechanics available 7 days a week for all your tires and mechanical needs.",
