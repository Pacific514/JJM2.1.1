  ...
  const slides: Slide[] = [
    {
      ...
      descriptionFr: "Nos mécaniciens certifiés se déplacent chez vous avec tout l'équipement nécessaire pour diagnostiquer et réparer votre véhicule sur place.",
      descriptionEn: "Our certified mechanics come to you with all the necessary equipment to diagnose and repair your vehicle on-site.",
    ...
    },
    {
      ...
      descriptionFr: "Service complet de changement de pneus saisonniers. Installation professionnelle, équilibrage et vérification de la pression inclus.",
    ...
    },
    {
      ...
      descriptionFr: "Nous sommes disponibles 7 jours sur 7 pour tous vos besoins mécaniques. Service d'urgence et rendez-vous flexibles selon votre horaire.",
      descriptionEn: "We are available 7 days a week for all your mechanical needs. Emergency service and flexible appointments according to your schedule.",
