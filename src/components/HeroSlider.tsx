  ...
  const slides: Slide[] = [
    {
      ...
      descriptionFr: "Nos mécaniciens mobile se déplacent avec tout l'équipement nécessaire pour diagnostiquer et réparer votre véhicule sur place.",
      descriptionEn: "Our mobile mechanics come with all the necessary equipment to diagnose and repair your vehicle on-site.",
