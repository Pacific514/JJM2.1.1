...
const HeroSlider: React.FC = () => {
  ...
  const slides: Slide[] = [
    ...
    },
    {
      ...
      descriptionFr: "Service mobile de changement de pneus saisonniers. Installation, balancement et vérification de la pression sur place.",
      descriptionEn: "Mobile seasonal tire change service. Installation, balancing and pressure check on-site.",
