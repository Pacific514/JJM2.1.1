...
const HeroSlider: React.FC = () => {
  ...
  const slides: Slide[] = [
    ...
    },
    {
      ...
      descriptionFr: "Service mobile de changement de pneus saisonniers. Installation, balancement et vérification de la pression inclus.",
      descriptionEn: "Mobile seasonal tire change service. Installation, balancing and pressure check included.",
    ...
    },
    {
      ...
      descriptionFr: "Rendez-vous flexibles selon votre horaire. Nous sommes disponibles 7 jours pour tous vos besoins mécaniques.",
